...
public class Motorcykel extends Fordon{
    ...
    /*De generiska metoder som implementeras från förälder klassen fordon*/
    void setMarke(){
        message = "Vilket märke ska motorcykeln ha?";
        String market;
    ...
    /*De generiska metoder som implementeras från förälder klassen fordon*/
    void setGear(){
        message = "Vilken växellåda ska motorcykeln ha?";
        String gear;
